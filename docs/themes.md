...
- **Catppuccin** - dark theme based on the soothing pastel Catppuccin Mocha palette
  <br><img loading="lazy" src="../images/themes/catppuccin.png" width="360" height="225" alt="Catppuccin theme">
- **Dracula** - dark theme with signature purple accents on a dark gray-purple background
  <br><img loading="lazy" src="../images/themes/dracula.png" width="360" height="225" alt="Dracula theme">
- **Ethereal** - dark blue theme with periwinkle accents and soft peach text
  <br><img loading="lazy" src="../images/themes/ethereal.png" width="360" height="225" alt="Ethereal theme">
- **Everforest** - dark forest-green theme with teal accents and warm earth tones
  <br><img loading="lazy" src="../images/themes/everforest.png" width="360" height="225" alt="Everforest theme">
- **Gruvbox** - dark theme with retro groove colors, aqua accents, and warm muted tones
  <br><img loading="lazy" src="../images/themes/gruvbox.png" width="360" height="225" alt="Gruvbox theme">
- **Hackerman** - dark cyberpunk theme with neon mint-green accents and icy cyan text
  <br><img loading="lazy" src="../images/themes/hackerman.png" width="360" height="225" alt="Hackerman theme">
- **Kanagawa** - dark theme inspired by the Great Wave, with crystal-blue accents and muted ink tones
  <br><img loading="lazy" src="../images/themes/kanagawa.png" width="360" height="225" alt="Kanagawa theme">
- **Lumon** - dark monochrome blue theme inspired by the Lumon Industries aesthetic
  <br><img loading="lazy" src="../images/themes/lumon.png" width="360" height="225" alt="Lumon theme">
- **Matte Black** - dark theme with orange/yellow accents
  <br><img loading="lazy" src="../images/themes/matte-black.png" width="360" height="225" alt="Matte Black theme">
- **Miasma** - dark swampy theme with olive accents and murky rust/gold earth tones
  <br><img loading="lazy" src="../images/themes/miasma.png" width="360" height="225" alt="Miasma theme">
- **Midnight** - SO-CRATES default dark theme
  <br><img loading="lazy" src="../images/themes/dark.png" width="360" height="225" alt="Midnight theme">
- **Monokai** - dark olive-brown theme with vivid lime-green accents, classic Sublime Text palette
  <br><img loading="lazy" src="../images/themes/monokai.png" width="360" height="225" alt="Monokai theme">
- **Nord** - dark arctic theme with frost-blue accents and aurora colors
  <br><img loading="lazy" src="../images/themes/nord.png" width="360" height="225" alt="Nord theme">
- **OhMyDebn** - dark theme matching OhMyDebn's own default desktop look, with periwinkle-blue accents
  <br><img loading="lazy" src="../images/themes/ohmydebn.png" width="360" height="225" alt="OhMyDebn theme">
- **Osaka Jade** - dark forest theme with jade-green accents and sage/cream text
  <br><img loading="lazy" src="../images/themes/osaka-jade.png" width="360" height="225" alt="Osaka Jade theme">
- **Retro 82** - dark navy theme with warm orange accents and teal highlights
  <br><img loading="lazy" src="../images/themes/retro-82.png" width="360" height="225" alt="Retro 82 theme">
- **Ristretto** - dark coffee-toned theme with salmon accents and warm rose-white text
  <br><img loading="lazy" src="../images/themes/ristretto.png" width="360" height="225" alt="Ristretto theme">
- **Solarized Dark** - classic low-contrast dark theme with muted blue-green base tones
  <br><img loading="lazy" src="../images/themes/solarized-dark.png" width="360" height="225" alt="Solarized Dark theme">
- **Tokyo Night** - dark theme with blue/purple accents inspired by the Tokyo Night palette
  <br><img loading="lazy" src="../images/themes/tokyo-night.png" width="360" height="225" alt="Tokyo Night theme">
- **Vantablack** - pure monochrome theme with white text on true black
  <br><img loading="lazy" src="../images/themes/vantablack.png" width="360" height="225" alt="Vantablack theme">

## Light Themes

- **Catppuccin Latte** - light theme based on the pastel Catppuccin Latte palette
  <br><img loading="lazy" src="../images/themes/catppuccin-latte.png" width="360" height="225" alt="Catppuccin Latte theme">
- **Flexoki Light** - light theme based on the warm, paper-like Flexoki palette, with blue accents
  <br><img loading="lazy" src="../images/themes/flexoki-light.png" width="360" height="225" alt="Flexoki Light theme">
- **Rose Pine** - light theme based on the warm Rosé Pine Dawn palette
  <br><img loading="lazy" src="../images/themes/rose-pine.png" width="360" height="225" alt="Rose Pine theme">
- **Sguil** - light theme inspired by the classic Sguil NSM interface, with gray chrome and navy headers
  <br><img loading="lazy" src="../images/themes/sguil.png" width="360" height="225" alt="Sguil theme">
- **White** - pure monochrome light theme with black text on true white
  <br><img loading="lazy" src="../images/themes/white.png" width="360" height="225" alt="White theme">
...
- **Breadbin Blue** - Commodore 64 blue-on-blue aesthetic (named for the C64's "breadbin" case), using the real Pepto/VICE C64 16-color palette (blue background, light-blue border/text/accent, cyan interactive highlight)
  <br><img loading="lazy" src="../images/themes/breadbin-blue.png" width="360" height="225" alt="Breadbin Blue theme">
- **CGA** - black background with the classic 4-color CGA Palette 1 High-Intensity hues (cyan, magenta, white)
  <br><img loading="lazy" src="../images/themes/cga.png" width="360" height="225" alt="CGA theme">
- **Digital Frontier** - black background with a glowing electric-blue accent and cyan/orange highlights, evoking a neon computer-generated grid world
  <br><img loading="lazy" src="../images/themes/digital-frontier.png" width="360" height="225" alt="Digital Frontier theme">
- **DOS Blue** - the flat cobalt-blue background of classic DOS text-mode UIs (Norton Commander, EDIT.COM, QBasic), using the real 16-color EGA/VGA palette values, with Norton Commander's iconic yellow function-key-label accent and cyan box-drawing borders
  <br><img loading="lazy" src="../images/themes/dos-blue.png" width="360" height="225" alt="DOS Blue theme">
- **Hacker** - green-on-black terminal aesthetic with a subtle animated code-rain background
  <br><img loading="lazy" src="../images/themes/hacker.png" width="360" height="225" alt="Hacker theme">
- **Luna Blue** - the saturated royal blue of the classic Windows XP "Luna Blue" taskbar and title bars as the dominant color, with the iconic Start-button green as the accent
  <br><img loading="lazy" src="../images/themes/luna-blue.png" width="360" height="225" alt="Luna Blue theme">
- **MP3 Player** - brushed-metal chrome grays evoking the skinnable media players of the late-90s/early-2000s, with a soft LCD-green readout and a cyan bezel highlight, plus a bouncing spectrum-analyzer background
  <br><img loading="lazy" src="../images/themes/mp3-player.png" width="360" height="225" alt="MP3 Player theme">
- **Retro Handheld** - pale yellow-green background with dark-green text, recreating the four-shade monochrome LCD screen of a classic late-'80s handheld game console
  <br><img loading="lazy" src="../images/themes/retro-handheld.png" width="360" height="225" alt="Retro Handheld theme">
- **Vaporwave** - dark purple/navy theme with hot-pink accents and cyan/mint/pastel-yellow highlights, evoking the modern (2010s+) vaporwave internet aesthetic
  <br><img loading="lazy" src="../images/themes/vaporwave.png" width="360" height="225" alt="Vaporwave theme">
